...
UNREALROOTPATH = /home/alemak/programs/UnrealEngine
GAMEPROJECTFILE =/home/alemak/projects/Demonless/Demonless.uproject
...
TARGETS = \
	...
	UnrealServer \
	Demonless-Linux-Debug  \
	Demonless-Linux-DebugGame  \
	Demonless-Linux-Test  \
	Demonless-Linux-Shipping  \
	Demonless \
	DemonlessEditor-Linux-Debug  \
	DemonlessEditor-Linux-DebugGame  \
	DemonlessEditor-Linux-Test  \
	DemonlessEditor-Linux-Shipping  \
	DemonlessEditor\
	configure
...
StandardSet: RequiredTools UnrealFrontend DemonlessEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug DemonlessEditor-Linux-Debug
...
Demonless-Linux-Debug:
	 $(PROJECTBUILD) Demonless Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Demonless-Linux-DebugGame:
	 $(PROJECTBUILD) Demonless Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Demonless-Linux-Test:
	 $(PROJECTBUILD) Demonless Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Demonless-Linux-Shipping:
	 $(PROJECTBUILD) Demonless Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Demonless:
	 $(PROJECTBUILD) Demonless Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

DemonlessEditor-Linux-Debug:
	 $(PROJECTBUILD) DemonlessEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

DemonlessEditor-Linux-DebugGame:
	 $(PROJECTBUILD) DemonlessEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

DemonlessEditor-Linux-Test:
	 $(PROJECTBUILD) DemonlessEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

DemonlessEditor-Linux-Shipping:
	 $(PROJECTBUILD) DemonlessEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

DemonlessEditor:
	 $(PROJECTBUILD) DemonlessEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
